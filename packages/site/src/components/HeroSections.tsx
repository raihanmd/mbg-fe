    ...
    <div className="w-full flex flex-col items-center">
      ...
      <section className="relative w-full min-h-[85vh] flex flex-col items-center justify-center bg-gradient-to-br from-[var(--color-bg)] via-[#0a192f] to-[var(--color-primary-dark)] px-6 overflow-hidden">
        ...
        <div className="relative z-10 text-center  mx-auto space-y-8">
				  ...
				  <h1 className="text-6xl  font-extrabold tracking-tight text-transparent bg-clip-text  text-white" style={{fontSize: "100px"}}>
            DCA Marketplace
          </h1>
          
          <p className="text-xl md:text-4xl text-gray-300 max-w-5xl mx-auto font-light leading-relaxed">
            Choose an asset, pick a schedule, and let AI‑assisted automation execute your Dollar Cost Averaging strategy effortlessly.
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-8">
            <a href="#get-skills" className="px-8 py-4 bg-[var(--color-primary)] hover:bg-[var(--color-primary-light)] text-black font-bold rounded-xl transition-all duration-300 shadow-[0_0_30px_rgba(0,200,83,0.3)] hover:shadow-[0_0_40px_rgba(0,200,83,0.5)] transform hover:-translate-y-1">
              Install Snap
            </a>
          </div>
        </div>
